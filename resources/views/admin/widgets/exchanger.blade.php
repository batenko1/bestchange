<div class="col-lg-3 col-md-3 col-sm-4 col-xl-6">
    <div class="card overflow-hidden">
        <div class="card-body">
            <div class="d-flex">
                <div class="mt-2">
                    <h6 class="">Обменников</h6>
                    <h2 class="mb-0 number-font">{{ $exchangers }}</h2>
                </div>
                <div class="ms-auto">
                    <div class="chart-wrapper mt-1"><div class="chartjs-size-monitor" style="position: absolute; inset: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                        ...
                        <canvas id="leadschart" class="h-8 w-9 chart-dropshadow chartjs-render-monitor" width="128" height="128" style="display: block; height: 64px; width: 64px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
